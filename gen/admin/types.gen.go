...
// Getter for additional properties for OrganizationDictionary. Returns the specified
// element and whether it was found
...
func (a *OrganizationDictionary) Set(fieldName string, value ProjectDictionary) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]ProjectDictionary)
	}
	a.AdditionalProperties[fieldName] = value
}
...
func (a *OrganizationDictionary) UnmarshalJSON(b []byte) error {
	...
	if len(object) != 0 {
		a.AdditionalProperties = make(map[string]ProjectDictionary)
		for fieldName, fieldBuf := range object {
			var fieldVal ProjectDictionary
			err := json.Unmarshal(fieldBuf, &fieldVal)
			if err != nil {
				return fmt.Errorf("error unmarshaling field %s: %w", fieldName, err)
			}
...
// Getter for additional properties for ProjectDictionary_Projects. Returns the specified
// element and whether it was found
...
func (a *ProjectDictionary_Projects) Set(fieldName string, value ProxyKeyProject) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]ProxyKeyProject)
	}
	a.AdditionalProperties[fieldName] = value
}
