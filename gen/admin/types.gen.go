...
const (
	Active         FeatureStatusStatus = "active"
	Inactive       FeatureStatusStatus = "inactive"
	NeverRequested FeatureStatusStatus = "never-requested"
)

// Defines values for SegmentFlagType.
const (
	CONDITION SegmentFlagType = "CONDITION"
	DIRECT    SegmentFlagType = "DIRECT"
)
