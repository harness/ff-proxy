	...
	return QueryStore{
		...
		S: func(identifier string) (rest.Segment, error) {
			...
			if err != nil {
				...
				s.logger.Debug(ctx, "segment not found in cache", "environment", environmentID, "identifier", identifier, "err", err.Error())
			}
		...
		L: func() ([]rest.FeatureConfig, error) {
			...
			if err != nil {
				...
				s.logger.Debug(ctx, "flags not found in cache", "environment", environmentID, "err", err.Error())
			}
