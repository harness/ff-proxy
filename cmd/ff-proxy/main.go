...
const (
	...
	configDirPathEnv      = "CONFIG_DIR_PATH"
	...
	configDirPathFlag              = "config-dir-path"
...
func init() {
	...
	flag.StringVar(&configDirPath, configDirPathFlag, "", "specify a custom path to search for /config directory when running in offline mode")
	...
	loadFlagsFromEnv(map[string]string{
		...
		configDirPathEnv:          configDirPathFlag,
